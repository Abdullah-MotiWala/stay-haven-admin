    ...
    return (<>
        ...
        <div className="flex justify-between items-center mb-3 px-4">
            <div className="flex gap-4">
                <p className="font-semibold text-24 ">Booking Details <span>- #321-02</span></p>
                <div className="bg-green-400 w-23 h-full rounded-lg">
                    <p className="text-[#107326] bg-green-400 p-1.5 px-3 rounded-full font-medium">Check-in</p>
                </div>
            </div>
