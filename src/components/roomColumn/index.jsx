...
const RoomCloumns = (props) => {
  ...
  const amenity = [
    ...
    {
      id: "Cold/Warm water",
      name: "Cold/Warm water",
      label: "Cold/Warm water",
    },
  ...
  const facilities = [
    ...
    {
      id: "Clean Linen & Towels",
      name: "Clean Linen & Towels",
      label: "Clean Linen & Towels",
    },
    ...
    {
      id: "Proper Ventilation",
      name: "Proper Ventilation",
      label: "Proper Ventilation",
    },
    {
      id: "Mirror & Vanity Area",
      name: "Mirror & Vanity Area",
      label: "Mirror & Vanity Area",
    },
    {
      id: "Bedside Switches",
      name: "Bedside Switches",
      label: "Bedside Switches",
    },
  ];
    ...
    <>
      ...
      <div className="max-full mx-auto mb-6">
        ...
        <div className="flex justify-between">
          <p className="text-sm text-[#545454] font-medium align-middle">
            Fill in the details below to add a new room to your hotel
            inventory.{" "}
          </p>
          <p className="flex justify-end font-medium text-[14px] text-dark">
            Step 2/2
          </p>
        </div>
      </div> */}
      ...
      >
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">
            {isEditMode ? "Edit Room" : "Add NewRoom"}
          </h1>
      ...
      <div className="w-full max-w-[1200px] mx-auto bg-white rounded-xl shadow-sm border border-gray-100 font-sans overflow-hidden">
        ...
        <div className="p-10 md:p-[15%] pt-5 pb-5">
          <h3 className="text-[22px] font-semibold text-gray-900 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-12">
            {feature.map((item) => (
              ...
              >
                ...
                <span
                  className={`text-[15px] font-medium transition-colors ${features[item.id] ? "text-blue" : "text-[#7C8DB5]"}`}
                >
                  {item.label}
                </span>
              </label>
