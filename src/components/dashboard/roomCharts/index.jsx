            ...
            <div key={unit.name} className="space-y-2">
              <div className="flex h-8 rounded-xl overflow-hidden">
                <div
                  ...
                  style={{ width: `${(unit.occupied / total) * 100}%` }}
                >
                  {unit.name}
                </div>
                <div className="bg-[#C24141]" style={{ width: `${(unit.available / total) * 100}%` }} />
                <div className="bg-[#F87171]" style={{ width: `${(unit.reserved / total) * 100}%` }} />
              </div>
