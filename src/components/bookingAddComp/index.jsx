...
const BookingAddComp = () => {
    ...
    const handleRoomSelect = (roomId) => {
        ...
        const selectedObj = rooms.find(item => item.id === roomId) || apartment.find(item => item.id === roomId);
        ...
        if (name === "hotelName") {
            ...
            if (selectedObj) {
                ...
                setHostData({
                    ...
                    profileImg: selectedObj.host?.image || "https://via.placeholder.com/150",
                        ...
                        <div className="lg:col-span-8 space-y-6">
                            ...
                            <div className="bg-white border border-gray-100 rounded-[24px] p-6 shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                                    ...
                                    <div className="flex flex-col">
                                        <label className="text-lightSeconday text-base font-bold ml-1">Number of Guests</label>
                                        <Select
                                            className="w-full h-12 border border-lightSeconday  rounded-lg font-medium"
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <p className="text-[#718096] text-13 font-semibold mb-0 tracking-wider">
                                                {formData.bookingType === "Apartment" ? "Apartment Selected" : "Room Selected"}
                                            </p>
                                            <p className="text-dark font-bold text-base">
                                                {formData.hotelName || "Not Selected"} {formData.roomNumber ? `#${formData.roomNumber}` : ""}
                                            </p>
                                        </div>
                                    ...
                                    <div className="flex justify-between item-center">
                                        <div className="flex flex-col justify-between text-14">
                                            ...
                                            <span className="text-dark font-bold">
                                                {formData.checkIn || "Start Date"} - {formData.checkOut || "End Date"}
                                            </span>
                                        </div>
                                        <p className="text-right text-dark font-bold mt-2 text-sm">{formData.duration || 0} Nights</p>
                                    </div>
                                    ...
                                    <div className="border-t-2 border-darkgrayline pt-4 space-y-3 text-14">
                                        ...
                                        <div className="flex justify-between font-medium text-dark">
                                            <span>Base Price {formData.duration} night (${formData.pricePerNight} x {formData.duration})</span>
                                            <span className="font-bold text-dark">${basePriceTotal.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between font-medium text-dark">
                                        ...
                                        <div className="flex justify-between font-medium text-dark">
                                            <span>Discount</span>
                                            <span className="font-bold text-red">-${discount.toFixed(2)}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="border-t-2 border-darkgrayline pt-4 space-y-4">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="text-xl font-bold text-blue">${totalPayable.toFixed(2)}</span>
                                        </div>
                                        <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="font-bold text-dark">${remainingBalance.toFixed(2)}</span>
                                        </div>
                                    </div>
