  ...
  return (
    <div className="bg-[#F8F9FD] min-h-screen pb-12 font-sans text-[#1A1A1A]">
      ...
      <div className="max-w-[1250px] mx-auto px-8 pt-8">
        <div
          className="flex items-center gap-2 text-gray-400 text-sm mb-6 cursor-pointer hover:text-blue-600 w-fit"
          onClick={() => navigate(-1)}
        >
        ...
        <form
          ...
          className="bg-white rounded-[24px] shadow-sm overflow-hidden border border-gray-100"
        >
          <div className="p-10">
            <h2 className="text-lg font-bold mb-10 text-[#1B2559]">
              Hotel Profile
            </h2>
            ...
            <div className="flex items-center gap-10 mb-12">
              ...
              <div className="flex-1">
                <h3 className="text-[#0052FF] font-bold text-xl cursor-pointer">
                  Upload Hotel Image
                </h3>
            ...
            <div className="grid grid-cols-2 gap-x-12 gap-y-8 mb-16">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full p-3.5 border border-gray-200 rounded-xl bg-[#F4F7FE] focus:bg-white focus:border-[#0052FF] outline-none transition-all"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="150"
                  className="w-full p-3.5 border border-gray-200 rounded-xl bg-[#F4F7FE] focus:bg-white outline-none"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full p-3.5 border border-gray-200 rounded-xl bg-[#F4F7FE] outline-none"
                >
            ...
            <div className="grid grid-cols-2 gap-16">
              <div>
                <h3 className="font-bold text-lg mb-6 text-[#1B2559]">
                  Ameneties Included
                </h3>
                  ...
                  {amenitiesList.map((item) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() => toggleItem("amenities", item)}
                  ...
                  {roomsList.map((room) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() => toggleItem("rooms", room)}
                        className="w-5 h-5 rounded accent-[#0052FF]"
                      />
                      <span className="text-sm text-gray-600 group-hover:text-blue-600">
                        {room}
          ...
          <div className="bg-white border-t border-gray-50 p-8 flex justify-end gap-5">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="px-10 py-2.5 border border-gray-200 rounded-full font-bold text-gray-400 hover:bg-gray-50"
            >
              Back
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-10 py-2.5 bg-[#0052FF] text-white rounded-full font-bold shadow-lg hover:bg-blue-700 disabled:bg-gray-400"
            >
